...
var polygons = ee.FeatureCollection([
  ...
  ee.Feature(sand, {'class': 4}),
  ee.Feature(houses, {'class': 5}),
  ee.Feature(buildings, {'class': 6}),
  ee.Feature(near_sea, {'class': 7}),
]);
...
Map.addLayer(classified,
            {min: 1, max: 7, palette: ['blue', '006600', '99ff33', 'FFFF00', 'ffffff', 'purple', '086bbd']},
            'classified image');